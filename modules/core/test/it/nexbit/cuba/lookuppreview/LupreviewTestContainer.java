package it.nexbit.cuba.lookuppreview;
...
public class LupreviewTestContainer extends TestContainer {

    public LupreviewTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "it/nexbit/cuba/lookuppreview/app.properties",
    ...
    public static class Common extends LupreviewTestContainer {

        public static final LupreviewTestContainer.Common INSTANCE = new LupreviewTestContainer.Common();
